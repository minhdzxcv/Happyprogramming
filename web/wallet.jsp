...
@media (max-width: 768px) {
    ...
    <link href="css/style.css" rel="stylesheet">
         <link href="css/8.97b85fe3.chunk.css" rel="stylesheet">
          ...
          <style>
              .rank-modal-dummy-layout .top-1{border-bottom:10px solid #f4f3f3;padding-bottom:10px}.rank-modal-dummy-layout .top-1 p:nth-child(2){margin:15px 0}.rank-modal-dummy-layout .top-10{margin:10px 0}.rank-modal-dummy-layout .top-10-child{padding:10px 0}.rank-modal-dummy-layout .top-10-child p{display:inline-table;vertical-align:middle}.rank-modal-dummy-layout .top-10-child p:first-child{margin-right:10px}.rank-modal-dummy-layout .top-10-child p:nth-child(2){margin:0 10px;line-height:0}.rank-modal-dummy-layout .top-10-child p:last-child{float:right}@media screen and (max-width:768px){.rank-modal{zoom:.85}.rank-modal .modal-content .rank-modal-tab ul.nav-tabs li a{font-size:1.3rem}.rank-modal .modal-content .modal-footer button{font-size:12px;padding:4px}.top-info-section .background-top1{position:absolute;top:-34px;left:calc(50% - 97px);height:149px;width:190px}}.recharge-modal .option{overflow:hidden}.type-card-mobile{position:relative;border-radius:4px;cursor:pointer;height:70px;margin-bottom:3px;margin-top:3px}.card--active{box-shadow:0 0 0 2px #09f}.type-card-mobile .discount-mobile{top:5px;right:5px;padding:0 5px}.type-card-mobile .discount-mobile,.type-card-playercode .discount-card{position:absolute;background-color:#f0564a;color:#fff;font-size:14px;font-weight:600}.type-card-playercode .discount-card{top:4px;right:19px;padding:0 3px}.type-card-mobile .img-thumbnail{height:100%}.recharge-modal .option .option-icon{width:30px;height:30px;float:left}.recharge-modal .option .option-title{float:left;margin-left:15px}.recharge-modal .option .option-title p:first-child{color:#333;font-size:13px;text-align:left;font-weight:700;font-family:Poppins}.recharge-modal .option .option-title p:last-child{font-weight:400;font-size:11px;text-align:left}.recharge-modal .option-content p{font-family:Poppins;font-size:13px;color:#333;margin-bottom:10px}.recharge-modal .option-content p:last-child{margin-bottom:0}.recharge-modal .option-content p .mr-5{margin-right:10px!important}.recharge-modal .option-content p button{width:100%}.recharge-modal .option-content .card .control-label,.recharge-modal .option-content .card .err-message{margin-bottom:0;padding-bottom:0;position:relative}mobile{margin:0;min-height:45px;position:relative}
