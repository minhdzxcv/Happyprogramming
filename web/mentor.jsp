...
<button type="submit" class="btn-fill btn btn-danger" id="btn-customer-request"><span>Tạo Request</span></button><button type="button" class="btn btn-default"><span>Đóng</span></button></div></form></div></div></div></div>';
                    let date = new Date();
        ...
        <script>
            ...
            function updateTotal() {
                ...
                if (total > ${sessionScope.holdMoney}) {
                    document.querySelector("#btn-customer-request").innerText = "Tài khoản không đủ";
                    document.querySelector("#btn-customer-request").disabled = true;
                } else {
                    document.querySelector("#btn-customer-request").innerText = "Tạo request";
                    document.querySelector("#btn-customer-request").disabled = false;
                }
