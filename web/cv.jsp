...
<html lang="en">
                                                    ...
                                                    <div class="d-flex flex-column align-items-center text-center">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <%
                                                                if(cv != null) {
                                                            %>
                                                            <p class="text-muted font-size-sm">Money of slot: <%=cv.getMoneyofslot()%></p>
                                                            <%
                                                            }
                                                            %>
                                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                                                            ...
                                                            <button type="button" class="btn btn-link" onclick="showRejectReason('Waiting for accept')">Xem lý do</button>
                                                        </div>
                                                        <%
                                                            }
                                                        %>
                                                    ...
                                                    if(cv != null) {%> 
                                                        <form method="post">
                                                            <input type="hidden" name="type" value="sendToAdmim">
                                                            <input class="form-control" type="hidden" name="id" min="1" required value="<%=cv.getId()%>">
                                                            <div class="card-body">
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                    ...
                                                                    <div class="col-sm-9 text-secondary">
                                                                        <textarea cols="5" rows="5" readonly class="form-control" name="profession" placeholder="" required maxlength="255" autocomplete="off"><%= cv.getProfessionIntro() == null ? "" : cv.getProfessionIntro() %></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                    ...
                                                                    <div class="col-sm-9 text-secondary">
                                                                        <textarea cols="5" rows="5" readonly class="form-control" name="descrip" placeholder="" required maxlength="255" autocomplete="off"><%= cv.getDescription() == null ? "" : cv.getDescription() %></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input class="form-control"type="hidden" name="MoneyOfSlot" min="1" required value="<%=cv.getMoneyofslot()%>">
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <button onclick="return confirm('Are you sure to send amdin?')" style="height: 100%; width: 30%; margin-left: 20px" class="btn btn-danger" type="submit" name="type" value="sendToAdmin">
                                                                        Submit
                                                                    </button>
                                                                    <% 
                                                                        }
                                                        ...
                                                        <%
                                                            if(cv == null) {
                                                        %>
                                                        <button style="height: 100% ; width: 30% ; margin-left: 300px" class="form-control"type="submit" class="btn-update" id="createCV">
                                                            CreateCV
                                                        </button>
                                                        <%
                                                        }
    ...
    <% } %>
    <%
        if(cv != null && ("Reject".equals(m.getStatus()) || "Draft".equals(m.getStatus()) || "Pending".equals(m.getStatus()) || "Accepted".equals(m.getStatus()))) {
    %>
