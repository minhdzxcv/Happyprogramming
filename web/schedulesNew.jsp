            ...
            <div  style="padding-top: 100px" class="menu__header fix-menu">
                <div class="container" style="width: 100000px">
                    <form action="new-schedule" method="post">
                        <button class="btn btn-success" type="submit" name="action" value="send" onclick="return confirm('Are you sure to send to admin?')">Send to admin</button>
