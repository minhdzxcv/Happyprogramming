        ...
        <button type="button" class="btn btn-default">\n\
          <span>Đóng</span>\n\
                                                                            ...
                                                                            btn[0].onclick = function () {
                                                                                ...
                                                                                document.body.lastChild.children[1].classList.remove("in");
                                                                                setTimeout(function () {
                                                                                    document.body.style = 'background-color: rgb(233, 235, 238) !important; isplay:flex';
                                                                                    document.body.removeChild(document.body.lastChild);
                                                                                    window.onclick = null;
                                                                                }, 100);
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                %>
                                                                <p>
                                                                    <a href="#" <%if(u.getRole().equalsIgnoreCase("mentor") && (s.getStatus().toLowerCase().contains("pending") || s.getStatus().toLowerCase().contains("not paid"))) {%>onclick="edit(<%=s.getId()%>)" <%}%>><%=s.getSkill() == null ? "Free" : s.getSkill()%>-</a>
                                                ...
                                                <div id="ctl00_divSupport">
                                                    <br>
                                                    <b>Mọi góp ý, thắc mắc xin liên hệ: <br></b><span style="color: rgb(34, 34, 34); font-family: arial, sans-serif; font-size: 13.333333969116211px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); display: inline !important; float: none;">Class: SE1814-Group6</span><br> Email: <a href="##">dungdthe172311@fpt.edu.vn</a>.
                                                    <br>Điện thoại: <span style="color: rgb(34, 34, 34); font-weight: bold; font-family: arial, sans-serif; font-size: 13.333333969116211px; font-style: normal; font-variant: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); display: inline !important; float: none;">0961326910 </span>
                                                    <br>
                                                </div>
                                                </p>
                                            </div>
