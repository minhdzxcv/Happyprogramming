...
public class MenteeRequest extends HttpServlet {
    ...
    throws ServletException, IOException {
        if(request.getSession().getAttribute("email") == null){
            ...
            request.setAttribute("list", new UserDAO().getRequestOfMentee(id));
            request.setAttribute("size", new UserDAO().getRequestMentor(id));
            request.getRequestDispatcher("menteeRequest.jsp").forward(request, response);
        }
    } 
