...
public class TransactionDAO {
    ...
    public static ArrayList<Withdraw> getWithdraw() throws Exception {
        ...
        try {
            PreparedStatement ps = dbo.prepareStatement("SELECT * FROM [Transaction] JOIN [User] On [Transaction].UserID = [User].UserID JOIN Bank ON [Bank].UserID = [User].UserID WHERE [Content] = N'Rút tiền' ORDER BY [Status] ASC");
